...
import { ApproveStudentComponent } from '../../students/approve-student/approve-student.component';
...
@Component({
  selector: 'app-view-stud-county-level',
  templateUrl: './view-stud-county-level.component.html',
  styleUrls: ['./view-stud-county-level.component.scss'],
})
export class ViewStudCountyLevelComponent {
  ...
  approveReject(flag: boolean) {
    console.log(this.studWardStatus);
